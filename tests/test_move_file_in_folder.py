...
from pages.elements.disk_left_panel import PATH_TO_FILE, DiskLeftPanel
from tests.conftest import create_folder, delete_file, move_file_in_folder, upload_file
